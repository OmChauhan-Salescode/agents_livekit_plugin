        ...
        async for chunk in llm_node:
            ...
            if isinstance(chunk, str):
                ...
                if chunk.metadata:
                    ...
                    logger.debug(f"_llm_inference_task METADATA: {chunk.metadata}")
                ...
                if chunk.delta.content:
                    ...
                    logger.debug(f"_llm_inference_task ID: {chunk.id}")
                ...
                if node_name_future is not None:
                    ...
                    if node_name_future.done():
                        try:
                            ...
                            node_name = None
                logger.debug(f"text_output node_name: {node_name}")
